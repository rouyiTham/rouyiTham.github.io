...
// Use the simpler badge implementation for better performance
const SimpleBadgeWrapper = dynamic(() => import("./simple-badge-wrapper"), {
  ssr: false,
  loading: () => <div></div>
})
...
export default function Navbar() {
  ...
  return (
    <SimpleBadgeWrapper badgeImage="/images/photo_design.png">
